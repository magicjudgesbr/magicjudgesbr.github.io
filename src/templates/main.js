...
// Event handling
    ...
    function initNav() {
        ...
        {%- if site.search_enabled and site.search.button -%}
        ...
        function update() {
            ...
            function addResult(resultsList, result) {
                ...
                for (var j in metadata) {
                    ...
                    if (meta.content) {
                        ...
                        for (var k in positions) {
                            ...
                            for (var k = 0; k < {{site.search.preview_words_before or 5}}; k++) {
                            ...
                            for (var k = 0; k < {{site.search.preview_words_after or 10}}; k++) {
                ...
                if (contentPositions.length > 0) {
                    ...
                    for (var j = 0; j < Math.min(previewPositions.length, {{site.search.previews or 3}}); j++) {
